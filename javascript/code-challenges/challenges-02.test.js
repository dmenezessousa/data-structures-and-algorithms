...
const addOne = (arr) => {
  // Solution code here...
  return arr.map((num) => num + 1); //one line solution from today's demo
};
...
const addQuestion = (arr) => {
  // Solution code here...
  return arr.map((str) => str + "?"); //one line solution from today's demo
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  return arr.map((num) => Math.pow(2, num)); //one line solution from today's demo
};
...
const charCode = (arr) => {
  // Solution code here...
  return arr.map((mappedLetter) => mappedLetter.charCodeAt(0));
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  return arr.map((snorlaxAbilities) => snorlaxAbilities.ability.name);
};
...
const extractStats = (arr) => {
  // Solution code here...
  return arr.map((snorlaxStatsArray) => {
    return {
      name: snorlaxStatsArray.stat.name,
      total: snorlaxStatsArray.effort + snorlaxStatsArray.baseStat,
    };
  });
};
