...
const screenForNames = (arr) => {
  // Solution code here...
  return arr.filter(name => { return /^((Mr|Mrs|Ms|Dr)\. )([a-zA-Z])+$/.test(name); });
...
const detectTicTacToeWin = (board) => {
  ...
  return helpCheck(0, 0, 0, 1, 0, 2) || helpCheck(1, 0, 1, 1, 1, 2) || helpCheck(2, 0, 2, 1, 2, 2) || helpCheck(0, 0, 1, 0, 2, 0) || helpCheck(0, 1, 1, 1, 2, 1) || helpCheck(0, 2, 1, 2, 2, 2) || helpCheck(0, 0, 1, 1, 2, 2) || helpCheck(0, 2, 1, 1, 2, 0);
};
